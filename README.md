...
The dataset is synthetically generated using Python for educational, research, and machine-learning purposes. According to the dataset documentation, it uses realistic medical ranges and clinically inspired risk factors and contains no real patient records or personally identifiable information.

**Dataset:** [Stroke Risk Prediction Dataset — Kaggle](https://www.kaggle.com/datasets/mobeenfatimah/stroke-risk-prediction-dataset)

**Creator:** Mobeen Fatimah
